...
struct RawPipelineConfig {
    ...
    statement_novelty_enabled: bool,
    statement_novelty_threshold: f64,
...
impl Default for RawPipelineConfig {
    fn default() -> Self {
        ...
        Self {
            ...
            statement_novelty_enabled: d.statement_novelty_enabled,
            statement_novelty_threshold: d.statement_novelty_threshold,
    ...
    fn into_config(self) -> Result<Config> {
        ...
        Ok(Config {
            ...
            pipeline: PipelineConfig {
                ...
                statement_novelty_enabled: self.pipeline.statement_novelty_enabled,
                statement_novelty_threshold: self.pipeline.statement_novelty_threshold,
...
fn merge_legacy_env_vars(mut figment: Figment) -> Figment {
    ...
    const LEGACY_MAPPINGS: &[(&str, &str)] = &[
        ...
        (
            "COVALENCE_STATEMENT_NOVELTY_ENABLED",
            "pipeline.statement_novelty_enabled",
        ),
        (
            "COVALENCE_STATEMENT_NOVELTY_THRESHOLD",
            "pipeline.statement_novelty_threshold",
        ),
