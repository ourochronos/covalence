...
class StatsResponse(BaseModel):
    ...
    nodes: NodeStats
    queue: QueueStats
    __properties: ClassVar[List[str]] = ["edges", "embeddings", "nodes", "queue"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "edges": EdgeStats.from_dict(obj["edges"]) if obj.get("edges") is not None else None,
            "embeddings": EmbeddingStats.from_dict(obj["embeddings"]) if obj.get("embeddings") is not None else None,
            "nodes": NodeStats.from_dict(obj["nodes"]) if obj.get("nodes") is not None else None,
            "queue": QueueStats.from_dict(obj["queue"]) if obj.get("queue") is not None else None
        })
        return _obj
